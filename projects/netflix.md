...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <img width="400px" ; margin: 0; class="rounded float-start pe-4" src="../img/netflix_radial_plot.png">
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <img width="400px" ; margin: 0; class="rounded float-start pe-4" src="../img/netflix_fastest.png">
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <img width="400px" ; margin: 0; class="rounded float-start pe-4" src="../img/netflix_map (2).png">
</div>
